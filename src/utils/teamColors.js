export const TEAM_COLORS = {
  ...
  'Alpine':        { primary: '#0077ff', secondary: '#ee3340', text: '#fff' },
  ...
  'Aston Martin':  { primary: '#006f62', secondary: '#cedc00', text: '#fff' },
  'Jordan':        { primary: '#f79900', secondary: '#000',    text: '#000' },
  'Force India':   { primary: '#ff80c7', secondary: '#000',    text: '#000' },
  'Racing Point':  { primary: '#f596c8', secondary: '#fff',    text: '#000' },
